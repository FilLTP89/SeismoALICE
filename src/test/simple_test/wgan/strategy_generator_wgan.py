...
class StrategyGeneratorWGAN(IStrategyGenerator):
    def __init__(self,network, accel, opt, *args, **kwargs):
        ...
        super(StrategyGeneratorWGAN, self).__init__(*args, **kwargs)

    
    def _optimizer_encoder(self,*args,**kwargs):
        return reset_net([self.Fy], optim='adam',alpha=0.9,lr=self.elr,b1=0.,b2=0.90)

    def _optimizer_decoder(self,*args, **kwargs):
        return reset_net([self.Gy],optim='adam',alpha=0.9,lr=self.dlr,b1=0.,b2=0.90)
