...
python ./src/aae_drive_bbfl.py --dataroot='./database/stead' --dataset='nt4096_ls4_nzf8_nzd128.pth'  --cutoff=1. --imageSize=4096 --latentSize=4  --niter=1001 --cuda --ngpu=1 --nzd=128 --nzf=8 --rlr=0.0001 --glr=0.0001 --outf='./imgs_bb_ls4_nf8_nzd128' --workers=8 --nsy=100 --batchSize=10 --actions='./actions_bb.txt' --strategy='./strategy_bb.txt' --save_checkpoint=1000 --config='./config/bb_ls4/test/nzd128/tentative_3.json'
