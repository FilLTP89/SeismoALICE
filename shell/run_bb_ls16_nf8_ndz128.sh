...
python ./src/aae_drive_bbfl.py --dataroot='./database/stead' --dataset='nt4096_ls16_nzf8_nzd128.pth' --cutoff=1. --imageSize=4096 --latentSize=16  --niter=5000 --cuda --ngpu=2 --nzd=128 --rlr=0.0001 --glr=0.0001 --outf='./imgs_bb_ls16_nf8_nzd128' --workers=8 --nsy=50 --batchSize=10 --actions='./actions_bb.txt' --strategy='./strategy_bb.txt' --save_checkpoint=2000 --config='./config/config_bb_ls4_nf8_ndz32.json'
