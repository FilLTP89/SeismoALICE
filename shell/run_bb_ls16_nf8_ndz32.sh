...
python ./src/aae_drive_bbfl.py --dataroot='./database/stead' --dataset='nt4096_ls16_nzf8_nzd32.pth' --cutoff=1. --imageSize=4096 --latentSize=16  --niter=1500 --cuda --ngpu=1 --nzd=32 --rlr=0.0003 --glr=0.0001 --outf='./imgs_bb_ls16_nf8_nzd32' --workers=8 --nsy=100 --batchSize=20 --actions='./actions_bb.txt' --strategy='./strategy_bb.txt' --save_checkpoint=2000 --config='./config/bb_ls16/test/tentative_6.json'>log_bb.txt 
