...
python ./src/aae/aae_drive_unic_tweaked_multi_branch_broadband.py \
    ...
    --summary_dir='./runs_both/broadband/zyy16/back-test/nsy1280/test-dxy/dummy/v1_lossl1_only/test/dis_in_train_fn_ali_4_repeat_2'\
    --root_checkpoint='./network/bb/zyy24/nsy1280/hack/dummy-4'\
