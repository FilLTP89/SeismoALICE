...
python ./src/aae/aae_drive_unic_tweaked_multi_branch_broadband.py \
    ...
    --workers=8 --nsy=1280 --batchSize=512 \
    --actions='./action/actions_unic.txt' --strategy='./strategy/strategy_unic.txt' \
    --save_checkpoint=200 \
    --summary_dir='./runs_both/broadband/zyy16/back-test/nsy1280/test-dxy/dummy/v1_lossl1_only/repeat-2/'\
    --root_checkpoint='./network/bb/zyy24/nsy1280/hack/dummy-2'\
    --config='./config/unic-zyy4-zxy4-split.json' 
