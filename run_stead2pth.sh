...
mpirun -np 8 python3 ./src/stea2data.py --dataroot='/home/kltpk89/Data/Filippo/aeolus/STEAD/waveforms_11_13_19.hdf5' --dataset='stead' --cutoff=1. --imageSize=4096 --latentSize=4 --niter=5000 --cuda --ngpu=2 --nzd=128 --rlr=0.0001 --glr=0.0001 --outf='./imgs' --workers=8 --nsy=100000 --batchSize=50 --actions='./actions_bb.txt' --strategy='./strategy_bb.txt' --save_checkpoint=2000 
